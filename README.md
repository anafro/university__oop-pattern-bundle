...
* Структурные:
  ...
  * Bridge: класс Cooker - это мостик между моим желудком и микроволновкой. Мне не нужно задумываться, как он будет че дам готовить да, я просто даю ему еду и такой "На, погрей её в микроволновке пж". И он греет, при этом зная, какие настройки нужно включить у микроволновки в зависимости от типа еды.
